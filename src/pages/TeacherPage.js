...
const TABLE_HEAD = [
  ...
  { id: 'teacherRoom', label: 'Teacher Room Number', alignRight: false },
...
export default function TeacherPage() {
  ...
  return (
    <>
      <Helmet>
        <title> Teacher | Find Teacher </title>
      </Helmet>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { _id, teacherName, qualifications, teacherRoom, designation, avatarUrl, deparment } = row;
                    ...
                    return (
                      <TableRow hover key={_id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell align="left">{teacherRoom}</TableCell>

                        <TableCell align="left">{designation}</TableCell>

                        <TableCell align="left">{deparment}</TableCell>
                      </TableRow>
                    );
                  })}
                  {emptyRows > 0 && (
