    ...
    <div className="w-full py-10 bg-bgColor">
      <div className="w-[80%] md:text-left text-center m-auto gap-8 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 ">
        <div className="flex flex-col gap-4">
          ...
          As one of the earliest Government Colleges in Faisalabad, Govt. Graduate College Samnabad Faisalabad is a unique
          and well reputed institute. It has the distinction of being the first Govt. College in Lyallpur since partition.
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col text-white gap-2">
            <p className="text-base  hover:text-textColor transition-all ease-out delay-100 cursor-pointer">
            GGCSF, College Road, Samanabad Faisalabad
            </p>
            <p className="text-base">
              <span className="text-textColor">Phone:</span>+92-300-0000000
            </p>
            <p className="text-base">
              <span className="text-textColor">Mail:</span>gpcsa.fsd@gmail.com
            </p>
            <p className="text-base">
